        ...
        <div class="col-lg-12">
          <div class="card card-primary card-outline">
            ...
            <div class="card-body table-responsive">
              <form method="post" action="<?php echo site_url('CTR_ATLaporan/tampilkan'); ?>">
                <div class="row">
              ...
              <form method="post" class="d-inline-flex" action="<?php echo site_url('CTR_ATLaporan/excel'); ?>">
                ...
                if ($row->status == 'Done') { ?>
                  <tr>
                    ...
                    <?php if ($row->status == 'Done') { ?>
                      <td align="center">
                        <a data-toggle="modal" data-target="#detail_atasan<?php echo $row->id_permintaan; ?>" href="#detail_atasan<?php echo $row->id_permintaan; ?>" class="btn btn-info" title="Detail Laporan"><i class="nav-icon fas fa-eye"></i></a>
                      </td>
                    <?php } ?>
                  </tr>
                  <?php $i++; ?>
