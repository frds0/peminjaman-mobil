...
class CTR_Penyelesaian extends CI_Controller
{
	...
	function __construct()
	{
		...
		$this->load->model('MODEL_Penyelesaian', 'data');
	...
	public function index()
	{
		...
		$this->load->view('User/Penyelesaian', $data);
		$this->load->view('Template/Footer');
	}

	// function tes()
	// {
	// 	$query = $this->db->query("SELECT * FROM tbl_detail_biaya_operasional WHERE id_permintaan = 1 ORDER BY id_detail DESC LIMIT 1")->row();
	// 	// print_r($query);
	// 	echo $query->id_detail;
	// }
	...
	public function TambahBaris()
	{
		...
		$this->load->view('User/TambahBaris', $data);
	}
	...
	public function TambahBarisRevisi()
	{
		$data['judul'] = 'PT. SIGAP PRIMA ASTREA';
		$data['baris'] = $this->input->post('count');
		$this->load->view('User/TambahBarisRevisi', $data);
	}
}
