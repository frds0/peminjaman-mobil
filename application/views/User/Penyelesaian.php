...
<div class="content-wrapper">
  ...
  <section class="forms">
    <div class="container-fluid">
      <div class="row">
        <div class="col-lg-12">
          <div class="card card-primary card-outline">
                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    <?php foreach ($permintaan as $row) {
                      if ($row->status == 'Dalam Perjalanan' || $row->status == 'Revisi') { ?>
                        <tr>
                          ...
                          <?php if ($row->status == 'Dalam Perjalanan') { ?>
                            <td align="center"><a data-toggle="modal" data-target="#edit_user<?php echo $row->id_permintaan; ?>" href="#edit_user<?php echo $row->id_permintaan; ?>" class="btn btn-success" title="Penyelesaian Data">Penyelesaian</a></td>
                          <?php } ?>

                          <?php if ($row->status == 'Revisi') { ?>
                            <td align="center"><a data-toggle="modal" data-target="#revisi_user<?php echo $row->id_permintaan; ?>" href="#revisi_user<?php echo $row->id_permintaan; ?>" class="btn btn-danger" title="Revisi Data">Revisi</a></td>
                          <?php } ?>
            ...
            <?php foreach ($permintaan as $row) {
              if ($row->status == 'Dalam Perjalanan' || $row->status == 'Revisi') { ?>
                <div class="modal fade" id="edit_user<?php echo $row->id_permintaan; ?>" tabindex="-1" aria-labelledby="edit_user<?php echo $row->id_permintaan; ?>" aria-hidden="true">
                  <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                      <div class="card-primary">
                        ...
                        <hr>
                        <form method="post" enctype="multipart/form-data" action="<?php echo site_url('CTR_Penyelesaian/EditData'); ?>">
                          <div class="card-body">
                              ...
                              <div class="row" id="barisdetail<?= $row->id_permintaan ?>">
                                ...
                                <div class="col-3">
                                  <div class="form-group">
                                    ...
                                    <!-- <img width="150px" height="100px" src="<?php echo base_url(); ?>assets/dist/img/forApps/no-picture.jpg"> -->
      ...
      <?php foreach ($permintaan as $row) {
        if ($row->status == 'Dalam Perjalanan' || $row->status == 'Revisi') { ?>
          <div class="modal fade" id="revisi_user<?php echo $row->id_permintaan; ?>" tabindex="-1" aria-labelledby="revisi_user<?php echo $row->id_permintaan; ?>" aria-hidden="true">
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="card-primary">
                  <div class="card-header">
                  ...
                  <div class="modal-body">
                    ...
                    <hr>
                    <form method="post" enctype="multipart/form-data" action="<?php echo site_url('CTR_Penyelesaian/RevisiData'); ?>">
                      ...
                      <?php if ($row->status == 'Revisi') { ?>
                        <div class="form-group">
                          ...
                          <?php if ($row->keterangan != '') { ?>
                            <textarea name="keterangan<?php echo $row->id_permintaan; ?>" class="form-control" readonly><?php echo $row->keterangan; ?></textarea>
                          <?php } else { ?>
                            <dd>-</dd>
                          <?php } ?>
                        </div>
                        ...
                        foreach ($detailbiaya as $row_detail) {
                          if ($row_detail->id_permintaan == $row->id_permintaan) { ?>
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-1">
                                <a data-toggle="modal" data-target="#gambar_user<?php echo $row_detail->id_detail; ?>">
                                  <img src="<?php echo base_url('./assets/img/' . $row_detail->gambar); ?>" width="80" height="80">
                                </a>
                              </div>
      ...
      <!-- Modal Zoom Gambar-->
      <!-- <?php foreach ($detailbiaya as $row_detail) { ?>
        <div class="modal fade" id="gambar_user<?php echo $row_detail->id_detail; ?>" tabindex="-1" aria-labelledby="gambar_user<?php echo $row_detail->id_detail; ?>" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              <div class="modal-body text-center">
                <img src="<?php echo base_url('./assets/img/' . $row_detail->gambar); ?>" width="500px" height="auto">
              </div>
              <div class="modal-footer">
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('body').on('click', '#add_row', function() {
      ...
      var action = 'item';
      $.ajax({
        url: '<?php echo base_url() ?>index.php/CTR_Penyelesaian/TambahBaris',
        method: 'POST',
        data: {
          action: action,
          count: count
    ...
    $('body').on('click', '#add_row_revisi', function() {
      ...
      var action = 'item';
      $.ajax({
        url: '<?php echo base_url() ?>index.php/CTR_Penyelesaian/TambahBarisRevisi',
        method: 'POST',
        data: {
          action: action,
          count: count
